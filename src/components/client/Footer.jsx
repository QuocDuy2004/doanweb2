  ...
  <footer className="bg-gray-900 text-white pt-12 pb-6">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          <span className="text-2xl font-bold text-indigo-400">ShopViet</span>
          <p className="mt-4 text-gray-400">
            Chúng tôi cung cấp những sản phẩm chất lượng với giá cả phải chăng. Sự hài lòng của khách hàng là ưu tiên hàng đầu của chúng tôi.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>123 Đường ABC, Quận 1, TPHCM</li>
            <li>Email: info@shopviet.com</li>
            <li>Hotline: 1900 1234 567</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
        <p className="text-gray-400 text-sm mb-4 md:mb-0">© 2025 ShopViet. Tất cả quyền được bảo lưu.</p>
