...
const ProductNew = () => {
  ...
  const fetchProducts = useCallback(async (signal) => {
    try {
      ...
      const errorMessage = err.response?.data?.message || "Không thể tải sản phẩm mới.";
  ...
  return (
    <div className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Sản phẩm mới nhất</h2>
        {loading ? (
          ...
          <div className="text-center text-gray-600">
            Không có sản phẩm mới nào đáp ứng điều kiện giảm giá.
          </div>
        )}
      </div>
    </div>
